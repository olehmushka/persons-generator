...
var JaponicWordBases = []*WordBase{JapaneseWordBase}

var KoreanWordBase = &WordBase{
	Name: "korean_wb",
	Words: []string{
		"Aewor",
		"Andong",
...
var KoreanWordBases = []*WordBase{KoreanWordBase}

var BasqueWordBase = &WordBase{
	Name: "basque_wb",
	Words: []string{
		"Abadio",
		"Abaltzisketa",
...
var BasqueWordBases = []*WordBase{BasqueWordBase}
