...
func serializeCultures(in []*culture.Culture) []*entities.Culture {
...
func serializeCulture(in *culture.Culture) *entities.Culture {
	if in == nil {
		return nil
	}
...
func serializeRoot(in *culture.Root) string {
	if in == nil {
		return ""
	}
	return in.Name
...
func serializeTraditions(traditions []*culture.Tradition) []string {
	if len(traditions) == 0 {
		return []string{}
	}
