...
var MalayaMongoloidFacePreset = face.NewFaceGene(
	...
	face.NewEyesGene(
		face.NewEyesTypeGene(map[string]float64{
			...
			string(face.ChildishRoundAsianEyesType): 0.33,
		}),
