...
var NordicMedititerraneanFacePreset = face.NewFaceGene(
	...
	face.NewEyesGene(
		...
		face.NewEyesColorGene(map[string]float64{
			color.BrownEyesColorPalette:    0.25,
			color.HazelEyesColorPalette:    0.2,
			color.AmberEyesColorPalette:    0.2,
			color.GreenEyesColorPalette:    0.2,
			color.GreyEyesColorPalette:     0.33,
			color.TealBlueEyesColorPalette: 0.33,
			color.CyanEyesColorPalette:     0.33,
			color.IndigoEyesColorPalette:   0.25,
		}),
	),
