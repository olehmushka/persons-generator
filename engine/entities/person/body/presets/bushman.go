...
var BushmanBodyPreset = body.NewBodyGene(
	facePresets.BushmanFacePreset,
	hairPresets.BushmanHairPreset,
	sizePresets.BushmanSizePreset,
	skinPresets.BushmanSkinPreset,
)
