...
var ArchipelagoBodyPreset = body.NewBodyGene(
	facePresets.ArchipelagoFacePreset,
	hairPresets.ArchipelagoHairPreset,
	sizePresets.ArchipelagoSizePreset,
	skinPresets.ArchipelagoSkinPreset,
)
