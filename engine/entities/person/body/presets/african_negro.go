...
var AfricanNegroBodyPreset = body.NewBodyGene(
	facePresets.AfricanNegroFacePreset,
	hairPresets.AfricanNegroHairPreset,
	sizePresets.AfricanNegroSizePreset,
	skinPresets.AfricanNegroSkinPreset,
)
