...
var RiverineBodyPreset = body.NewBodyGene(
	facePresets.RiverineFacePreset,
	hairPresets.RiverineHairPreset,
	sizePresets.RiverineSizePreset,
	skinPresets.RiverineSkinPreset,
)
