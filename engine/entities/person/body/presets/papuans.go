...
var PapuansBodyPreset = body.NewBodyGene(
	facePresets.PapuansFacePreset,
	hairPresets.PapuansHairPreset,
	sizePresets.PapuansSizePreset,
	skinPresets.PapuansSkinPreset,
)
