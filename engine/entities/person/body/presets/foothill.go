...
var FoothillBodyPreset = body.NewBodyGene(
	facePresets.FoothillFacePreset,
	hairPresets.FoothillHairPreset,
	sizePresets.FoothillSizePreset,
	skinPresets.FoothillSkinPreset,
)
