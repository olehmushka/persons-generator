...
var MedititerraneanBodyPreset = body.NewBodyGene(
	facePresets.MedititerraneanFacePreset,
	hairPresets.MedititerraneanHairPreset,
	sizePresets.MedititerraneanSizePreset,
	skinPresets.MedititerraneanSkinPreset,
)
