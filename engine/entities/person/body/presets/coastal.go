...
var CoastalBodyPreset = body.NewBodyGene(
	facePresets.CoastalFacePreset,
	hairPresets.CoastalHairPreset,
	sizePresets.CoastalSizePreset,
	skinPresets.CoastalSkinPreset,
)
