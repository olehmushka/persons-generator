...
var TimberlandBodyPreset = body.NewBodyGene(
	facePresets.SteppeFacePreset,
	hairPresets.SteppeHairPreset,
	sizePresets.SteppeSizePreset,
	skinPresets.SteppeSkinPreset,
)
