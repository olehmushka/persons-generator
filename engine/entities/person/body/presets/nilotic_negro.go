...
var NiloticNegroBodyPreset = body.NewBodyGene(
	facePresets.NegritoFacePreset,
	hairPresets.NegritoHairPreset,
	sizePresets.NegritoSizePreset,
	skinPresets.NegritoSkinPreset,
)
