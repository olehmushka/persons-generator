...
var SavannaBodyPreset = body.NewBodyGene(
	facePresets.SavannaFacePreset,
	hairPresets.SavannaHairPreset,
	sizePresets.SavannaSizePreset,
	skinPresets.SavannaSkinPreset,
)
