...
var MontaneBodyPreset = body.NewBodyGene(
	facePresets.MontaneFacePreset,
	hairPresets.MontaneHairPreset,
	sizePresets.MontaneSizePreset,
	skinPresets.MontaneSkinPreset,
)
