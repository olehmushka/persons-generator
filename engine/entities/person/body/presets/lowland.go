...
var LowlandBodyPreset = body.NewBodyGene(
	facePresets.LowlandFacePreset,
	hairPresets.LowlandHairPreset,
	sizePresets.LowlandSizePreset,
	skinPresets.LowlandSkinPreset,
)
