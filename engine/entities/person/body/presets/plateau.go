...
var PlateauBodyPreset = body.NewBodyGene(
	facePresets.PlainsFacePreset,
	hairPresets.PlainsHairPreset,
	sizePresets.PlainsSizePreset,
	skinPresets.PlainsSkinPreset,
)
